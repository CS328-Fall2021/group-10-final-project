...
def onSpeakerDetected(instrument):
    """
    Notifies the user of the current speaker
    """
    print("The instrument being played is {}.".format(instrument))
    sys.stdout.flush()
...
def predict(window):
    ...
    classes = ['Guitar', 'Piano', 'Harmonica', 'Saxophone', 'No sound'] #...
...
receive_socket.connect(("salinas.cs.umass.edu", 9801))
